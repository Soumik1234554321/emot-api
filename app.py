...
Hr = {
    ...
    'X-GA': "v1 1",
    'ReleaseVersion': "OB52"}  # OB51 से OB52 में बदला
...
async def EncRypTMajoRLoGin(open_id, access_token):
    ...
    major_login.client_version = "1.120.2"  # OB52 के लिए अपडेट किया
    ...
    major_login.client_version_code = "2019116753"  # OB52 के लिए अपडेट किया
...
async def lag_team_loop(team_code, key, iv, region):
    ...
    print(f"⏰ Auto-stop in: 5 minutes")
    ...
    while lag_running:
        try:
            ...
            if elapsed_time >= max_duration:
                print("⏰ 5 minutes completed! Auto-stopping lag attack...")
                lag_running = False
...
async def MaiiiinE():
    ...
    Uid, Pw = '4231218210', '1AB1ED87C726392E7E5503F654CB23DFCF56E43918669C0BBEB26B973A153D7E'
